...
public class QnaController {
	...
	public @ResponseBody List<Qna> getFaqList(String surf, String search_key){//subject�뒗 寃��깋李쎌뿉 �엯�젰�븳 �뀓�뒪�듃, search_key�뒗 '�젣紐�'�씤吏� '�궡�슜'�씤吏�.
	...
	public String reply(Qna qna) {
		int go = qnaService.getGroupOrd(qna.getSeq());//qna.java�뿉 媛�硫� @Data濡� 紐⑤뱺 蹂��닔�뱾�쓽 寃뚰꽣,�꽭�꽣媛� �븞蹂댁씠吏�留� �깮�꽦�릺�뼱�엳�떎. 洹몄쨷 寃뚰꽣seq瑜� 媛��졇�삩�떎�뒗 �쑜.

		qna.setGroupOrd(go+1);//qna.java �븞�뿉 setGroupOrd�뿉 �씠�윴�떇�쑝濡� 諛붾줈 �뙆�씪誘명꽣 �븞�뿉 �뜲�씠�꽣瑜� �떞�쓣 �닔 �엳�떎.
