...
(function(i, s, o, g, r, a, m) {
    ...
    a.src = g;
    a.onload = function() {
        i[r].init('https://js-error-tracer-api.cafe24.com', {"token":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..DGnGrzB_rFtwv8BnYNBgQifuCPYexSybfc9wV-CeY90","collectWindowErrors":true,"preventDuplicateReport":true,"storageKeyPrefix":"EC_JET.BOARD_GALLERY_LIST"});
    };
    m.parentNode.insertBefore(a, m);
														...
														<link rel="canonical"
															href="http://rlgh2587.cafe24.com/board/갤러리/8/" />
														<meta property="og:url"
															content="http://rlgh2587.cafe24.com/board/갤러리/8/" />
														<meta property="og:title" content=" 갤러리 - 기호제학" />
														<meta property="og:description" content="갤러리입니다." />
														<meta property="og:site_name" content="기호제학" />
														<meta property="og:type" content="article" />
														<script type="text/javascript"
															src="/app/Eclog/js/cid.generate.js?vs=f475bababadb6ba10c84bf80abdec3f7"></script>
<script>													
<!-- 화살표 기능 구현 -->
...
#front-linker {
	...
	height: 61px;
	background:
		url(//img.echosting.cafe24.com/smartAdmin/img/design/ko_KR/sfix_linker.png)
		repeat 0 0;
}
	...
	background:
		...
		no-repeat;
														...
														<meta name="design_html_path"
															content="/board/gallery/list.html" />
</head>
<body>
	...
	<div id="wrap">
		<div id="container">
			...
			<div
				...
				<div class="titleArea">
					<h1 style="text-align: center;">
						<font color="333333">로컬체험</font>
					</h1>
					<p>제주프렌즈의 로컬체험리스트</p>
				</div>

				<div
					class="xans-element- xans-layout xans-layout-boardinfo cboth event_tab">
					<ul>
						<li rel="공지사항" class="xans-record-"><a
							href="/jejufriends/food/list.do?cp=1" class="move">맛집</a></li>
						<li rel="상품 Q&A" class="xans-record-"><a
							href="/jejufriends/landmark/list.do?cp=1" class="move">관광지 </a></li>
						<li rel="공지사항" class="xans-record-"><a
							href="/jejufriends/activity/list.do?cp=1" class="move">로컬체험</a></li>
						<li rel="상품 Q&A" class="xans-record-"><a
							href="/jejufriends/hotel/list.do?cp=1" class="move">숙소</a></li>
					</ul>
				</div>
			...
			<div id="contents">
				...
				<div
					class="xans-element- xans-board xans-board-listpackage-3001 xans-board-listpackage xans-board-3001 ">
					<div
						class="xans-element- xans-board xans-board-title-3001 xans-board-title xans-board-3001 ">
						<div class="path">
							<h2>현재 위치</h2>
							<ol>
								<li><a href="/">홈</a></li>
					...
					<ul
						class="xans-element- xans-board xans-board-listheader-3001 xans-board-listheader xans-board-3001">
						<li class=""><a class="displaynone"
							href="/board/gallery/list.html?&board_no=8&category_no=1&cate_no=1&category_no=1"><img
								src="http://img.echosting.cafe24.com/skin/base_ko_KR/board/btn_type_image.gif"
								alt="이미지형으로 보기" /></a></li>
						<li class=""><a class="displaynone"
							href="/board/gallery/list2.html?&board_no=8&category_no=1&cate_no=1&category_no=1"><img
								src="http://img.echosting.cafe24.com/skin/base_ko_KR/board/btn_type_list.gif"
								alt="리스트형으로 보기" /></a></li>
					</ul>
					<div
						class="xans-element- xans-board xans-board-list-3001 xans-board-list xans-board-3001">
						<!--
            $count = 12
        ...
        -->
						<ul>
							...
							<c:forEach items="${listResult.list}" var="activity">
								<li class="xans-record-"><a
									href='content.do?anum=${activity.anum }' class="imgLink"><img
										src="/photo/${activity.aphoto }"
										onerror="this.src='http://img.echosting.cafe24.com/skin/base_ko_KR/board/@img_gallery.gif'"
										alt="" /></a> <a href='content.do?anum=${activity.anum }'
									class="imgLink">${activity.aname } </a> <span> <strong>
											${activity.aintro} </strong> <em>영업시간 : ${activity.aopcl}</em> <em>조회수
											: ${activity.views}</em>
								</span></li>
							</c:forEach>
						</ul>
				...
				<div
					class="xans-element- xans-board xans-board-paging-8 xans-board-paging xans-board-8 ec-base-paginate">
					</a>
					<button onclick="pageMove('back');" style="display: inline;">
						<img
					...
					<c:forEach begin="1" end="${listResult.totalPageCount}" var="i">
						<c:choose>
							<c:when test="${i==listResult.cp}">
								<li class="xans-record-"><a href="list.do?cp=${i}"
									class="this">${i}</a></li>
								<!-- 원래는 다 회색이었는데 this라는 클래스때문에 검은색으로 바뀜 -->
							</c:when>
							<c:otherwise>
					...
					<!-- 페이징 -->
					<button onclick="pageMove('next');" style="display: inline;">
						<img
				...
				<li class="xans-record-"><a
					href="?board_no=8&category_no=1&cate_no=1&page=1&category_no=1"
					class="this"></a></li>

			</div>

			<form id="boardSearchForm" name="boardSearchForm" action="search.do"
					...
					<fieldset class="boardSearch">
						...
						<div
							...
							<select id="search_key" name="search_key" fw-filter=""
								fw-label="" fw-msg="">
								<option value="aname">제목</option>
								<option value="aintro">내용</option>
							</select> <input id="surf" name="surf" fw-filter="" fw-label="" fw-msg=""
								class="inputTypeText" placeholder="" value="" type="text"
								style="margin-left: 10px;" />
							<button type="submit" href="#" class="btnEmFix"
								style="margin-left: 10px;">찾기</button>
						</div>
					</fieldset>
				</div>
			</form>
	...
	<!-- 180430 플로팅버튼추가 -->
	<script type="text/javascript"
		src="https://cdn.jejujini.kr/resources/KR/js/libs/css_common.js?r=13"></script>
	<link rel="stylesheet" type="text/css"
		href="https://cdn.jejujini.kr/resources/KR/css/common.css?r=13" />
	<link rel="stylesheet" type="text/css"
		href="https://cdn.jejujini.kr/resources/KR/css/new_common.css?r=13" />
	<div class="floating">
		<!-- 180827 sub class 삭제  -> 다시 추가 -->
		<!-- 180831 탑버튼 추가 -->
		<button type="button" class="topBtn"
			onclick="$('body').scrollTop(0); return false;">탑버튼</button>
		<!-- MSG : 탑버튼 -->
