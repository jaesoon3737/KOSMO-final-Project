...
<div id="container">
	...
	<div class="titleArea">
	            <h1 style="text-align:center;"><font color="333333">로컬체험</font></h1>
	            <p>제주프렌즈의 로컬체험리스트</p>
	        </div>
...
<ul>
			...
			<li class="xans-record-">
			                <a href='content.do?anum=${activity.anum }' class="imgLink"><img src="/photo/${activity.aphoto }" onerror="this.src='http://img.echosting.cafe24.com/skin/base_ko_KR/board/@img_gallery.gif'" alt=""/></a>
			                <a href='content.do?anum=${activity.anum }' class="imgLink">${activity.aname } </a>
			                <span>
			                    <strong>맛집내용 : ${activity.aintro} </strong>
			                    <em>영업시간 : ${activity.aopcl}</em>
			                    <em>조회수 : ${activity.views}</em>
			                </span>
			            </li>
			            </c:forEach> 
			        </ul>
