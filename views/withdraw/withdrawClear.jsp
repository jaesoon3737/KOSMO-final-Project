...
<sec:authentication property="principal.username" var = "emailSession"/>
	   ...
	   <div class="card card-authentication1 mb-0">
			<div class="card-body">
			 <div class="card-content p-2">
			  <div class="card-title text-uppercase pb-2">회원탈퇴 철회 후 정상적인 사용이 가능합니다.</div>
			    <p class="pb-1">변경할 비밀번호를 입력하세요.</p>
			    <form   method="post" action="/jejufriends/member/withdraw/clear">
				  <input name="${_csrf.parameterName}" type="hidden" value="${_csrf.token}"/>
				  <input name="email"  type="hidden" value = "<c:out value='${emailSession}'/>"/>
				   <div class="form-group">
				  	 <label for="pwd" class="sr-only">Password</label>
				 		  <div class="position-relative has-icon-right">
							  <input type="password"  id="pwd"  name="pwd"  class="form-control input-shadow" placeholder="10~20 자리 특수문자,소문자,숫자조합"  maxlength="20" minlength="10" />
				  ...
				  <div class="form-group">
					 ...
					 <div class="position-relative has-icon-right">
						  <input type="password"   id="pwdCheck" name="pwdCheck" class="form-control input-shadow" placeholder="Check Password "  maxlength="20" minlength="10">
						  <div class="form-control-position">
			 ...
			 <div class="card-footer text-center py-3">
			    <p class="text-warning mb-0">탈퇴 철회를 진행하지 않으십니끼? <a href="/jejufriends"> 홈 </a></p>
			 </div>
		 </div>
	  </div>
