	...
	<div id="wrap">
        ...
        -->
						<ul>
							...
							<c:forEach items="${listResult.list}" var="hotel">
								<li class="xans-record-"><a
									href='content.do?hnum=${hotel.hnum }' class="imgLink"><img
										src="/photo/${hotel.hphoto }"
										onerror="this.src='http://img.echosting.cafe24.com/skin/base_ko_KR/board/@img_gallery.gif'"
										alt="" /></a> <a href='content.do?hnum=${hotel.hnum }'
									class="imgLink">${hotel.hname } </a> <span> <strong>
											${hotel.hintro} </strong>  <em>조회수
											: ${hotel.views}</em>
								</span></li>
							</c:forEach>
						</ul>
					...
					<fieldset class="boardSearch">
						...
						<div
							...
							<select id="search_key" name="search_key" fw-filter=""
								fw-label="" fw-msg="">
								<option value="hname">제목</option>
								<option value="hintro">내용</option>
