...
<div id="container">
	...
	<div class="titleArea">
	            <h1 style="text-align:center;"><font color="333333">숙소</font></h1>
	            <p>제주프렌즈의 숙소리스트</p>
	        </div>
...
<ul>
			...
			<li class="xans-record-">
			                <a href='content.do?hnum=${hotel.hnum }' class="imgLink"><img src="/photo/${hotel.hphoto }" onerror="this.src='http://img.echosting.cafe24.com/skin/base_ko_KR/board/@img_gallery.gif'" alt=""/></a>
			                <a href='content.do?hnum=${hotel.hnum }' class="imgLink">${hotel.hname } </a>
			                <span>
			                    <strong>호텔내용 : ${hotel.hintro} </strong>
			                    <em>조회수 : ${hotel.views}</em>
			                </span>
			            </li>
			            </c:forEach> 
			        </ul>
