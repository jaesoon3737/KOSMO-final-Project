...
<div id="container">
	...
	<div class="titleArea">
	            <h1 style="text-align:center;"><font color="333333">관광지</font></h1>
	            <p>제주프렌즈의 관광지리스트</p>
	        </div>
...
<ul>
			...
			<li class="xans-record-">
			                <a href='content.do?lnum=${landmark.lnum }' class="imgLink"><img src="/photo/${landmark.lphoto }" onerror="this.src='http://img.echosting.cafe24.com/skin/base_ko_KR/board/@img_gallery.gif'" alt=""/></a>
			                <a href='content.do?lnum=${landmark.lnum }' class="imgLink">${landmark.lname } </a>
			                <span>
			                    <strong>맛집내용 : ${landmark.lintro} </strong>
