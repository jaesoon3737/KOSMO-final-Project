	...
	<div id="wrap">
        ...
        -->
						<ul>
							...
							<c:forEach items="${listResult.list}" var="landmark">
								<li class="xans-record-"><a
									href='content.do?lnum=${landmark.lnum }' class="imgLink"><img
										src="/photo/${landmark.lphoto }"
										onerror="this.src='http://img.echosting.cafe24.com/skin/base_ko_KR/board/@img_gallery.gif'"
										alt="" /></a> <a href='content.do?lnum=${landmark.lnum }'
									class="imgLink">${landmark.lname } </a> <span> 
									<strong>${landmark.lintro} </strong>  
											<em>영업시간 : ${landmark.lopcl}</em>
											<em>조회수 : ${landmark.views}</em>
								</span></li>
							</c:forEach>
						</ul>
					</div>
					...
					<fieldset class="boardSearch">
						...
						<div
							...
							<select id="search_key" name="search_key" fw-filter=""
								fw-label="" fw-msg="">
								<option value="lname">제목</option>
								<option value="lintro">내용</option>
