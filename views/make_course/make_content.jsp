...
<div id="wrap">
	...
	<tbody>
	<tr>
	<td class="board_subject" colspan="2">${makeCourse.contentname}</td>
	                </tr>
			<tr>
	...
	<div style="width: 700px; height: 500px; margin-top: 40px; margin-left: 290px;">
		<div >
			<img src="/photo/${makeCourse.contentphoto}"  border="0" alt=""  style="width: 100%; height: 500px;"/>
			<!--  
